document.addEventListener('DOMContentLoaded', () => {
    ...
    console.log('UnitySync - Platform Initialized');
...
const API_KEY = "AIzaSyC6_QNsQM7inOkDdDvlTaLZiyxXxm69qz8"; 
...
const chatHistory = [
  {
    role: "model",
    parts: [{ text: `You are the AI Assistant for the UnitySync NGO Platform. Keep your answers focused on NGO coordination, discovering volunteers, routing donations, and community impact.` }],
  },
];
...
const generateBotResponse = async (incomingMessageDiv) => {
  ...
  try {
    ...
    console.log(error);
    messageElement.innerText = "Oops! Could not connect to the Assistant API.";
...
const handleOutgoingMessage = (e) => {
  ...
  messageInput.value = "";
  if(messageInput.dispatchEvent) messageInput.dispatchEvent(new Event("input"));
...
if(document.querySelector("#file-upload")) document.querySelector("#file-upload").addEventListener("click", () => fileInput.click());
